...
# Constants with your credentials
...
SCOPE = ['openid', 'profile', 'email']  # Updated to be a list as expected by OAuth2Session
...
def handle_oauth():
    ...
    if "code" not in st.experimental_get_query_params():
        ...
        try:
            ...
            st.write("Your LinkedIn email information:", email_info['elements'][0]['handle~']['emailAddress'])
