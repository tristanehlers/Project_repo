...
SCOPE = ['r_liteprofile', 'r_emailaddress']  # Scopes for OpenID Connect
...
def main():
    ...
    if "user_info" in st.session_state:
        ...
        # Optionally, display the decoded id_token data
        if "id_token_data" in st.session_state:
            st.write("Your LinkedIn ID token data:")
            st.json(st.session_state['id_token_data'])
